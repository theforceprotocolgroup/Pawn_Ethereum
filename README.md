...
点对点借贷让借贷双方能够自由的确定借贷的条款，但是也带来了很多不便，参与点对点借贷，用户需要自主发布、管理贷款订单，在抵押借贷的情况下，借贷双方需要随时关注抵押物的价格变化，同时，一笔点对点借贷订单从发布到最终成交，往往需要经过漫长的等待，这些不足之处都限制了点对点借贷业务的规模。
...
币币贷在创立初期就设立了点对点借贷、集中借贷两种业务模式的技术架构，在实际发展中，我们先落地并完善了点对点借贷协议，在开发集中借贷功能的过程中，我们参考了Compound借贷协议的理念，精简了我们原有的基于不同借款周期的资金池模型，对每种特定的借贷资产只采用一种集中借贷模式。我们改进了Compound协议在利率模型、cToken设计等方面的不足，提出了币币贷原创的集中借贷产品架构。
...
币币贷dApp的治理采取社区治理和管理团队相结合的形式，管理团队负责日常的dApp运营维护，涉及增加新的稳定币资金池，更新全局利率模型，更新oracle地址，修改利息调整比例，管理团队改选等重大事项时，将经过社区的充分讨论和投票；其余日常运营工作由币币贷团队成员负责执行。
